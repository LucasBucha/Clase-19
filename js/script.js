...
var mainContainer = document.getElementById("container")
	...
	function writeNew(title, content, images, link)
	{
		...
		comprar.setAttribute("href", document.getElementById("link").value);
	...
	function cardEdit(container, title, content, images, link)
	{
		...
		container.querySelector("img").setAttribute("src", document.getElementById("images").value);
		container.querySelector("a").setAttribute("href", document.getElementById("link").value);
